...
let planetSize = window.innerWidth > 930 ? 0.5 : 0.3; // Initial size based on screen width
...
function main()
{
    ...
    const earthGeometry = new THREE.SphereGeometry(planetSize, 32, 32);
    ...
    const cloudGeometry =  new THREE.SphereGeometry(planetSize + 0.02, 32, 32);
    const cloudMaterial = new THREE.MeshPhongMaterial({
        map: new THREE.TextureLoader().load('texture/MindBlindClouds.png'),
        transparent: true
    });
